  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		<div class="box">
            <!-- /.box-header -->
            <div class="box-body">
				<form id="form-submit-food" class="form-horizontal" action="<?=base_url()?>users/saveadd" method="POST" enctype="multipart/form-data">
					<div class="box-body">
					<?php
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control user_name" name="user_name" data-validation="required" placeholder="กรุณาระบุชื่อ-สกุล">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">ที่อยู่</label>
						<div class="col-sm-3">
							<textarea rows="5" class="form-control user_addrass" name="user_addrass" placeholder="กรุณาระบุที่อยู่"></textarea>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							 <input type="text" class="form-control" name="user_tel" value="" data-validation="required" placeholder="กรุณาระบุหมายเลขโทรศัพท์ " maxlength="10">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">ไปรษณีย์</label>
						<div class="col-sm-3">
							 <input type="text" class="form-control" name="user_post" value="" data-validation="required" placeholder="กรุณาระบุไปรษณีย์ " maxlength="5">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">อัพโหลดรูปภาพ</label>
						<div class="col-sm-3">
							 <input type="file" id="user_img" class="form-control" name="user_img" placeholder="กรุณาระบุอัพโหลดรูปภาพ ">
						</div>
					</div>
				...
				<div class="box-footer">
					<button type="submit" id="btn-submit-item" class="btn btn-success btn-flat">
