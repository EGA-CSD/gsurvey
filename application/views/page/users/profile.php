  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		<div class="box">
            <!-- /.box-header -->
            <div class="box-body">
				<form id="form-submit-food" class="form-horizontal" action="<?=base_url()?>users/saveeditprofile" method="POST" enctype="multipart/form-data">
					<div class="box-body">
					<?php
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							 <input type="text" class="form-control" name="user_tel" value="<?=$data['user_tel']?>" data-validation="required" placeholder="กรุณาระบุหมายเลขโทรศัพท์ ">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">ไปรษณีย์</label>
						<div class="col-sm-3">
							 <input type="text" class="form-control" name="user_post" value="<?=$data['user_post']?>" data-validation="required" placeholder="กรุณาระบุไปรษณีย์ ">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							 ...
							 <input type="hidden" name="user_img_old" value="<?=$data['user_img_old']?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							 <input type="text" class="form-control" name="user_login_name" value="<?=$data['user_login_name']?>" data-validation="required" placeholder="กรุณาระบุชื่อผู้ใช้งานระบบ ">
							 <input type="hidden" name="hide_user_login_name" value="<?=$data['user_login_name']?>">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">รหัสผ่าน</label>
						<div class="col-sm-3">
							 <input type="password" class="form-control" name="user_login_pass" value="<?=$data['user_login_pass']?>" data-validation="required" placeholder="กรุณาระบุรหัสผ่าน ">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">ยืนยันรหัสผ่าน</label>
						<div class="col-sm-3">
							 <input type="password" class="form-control" name="user_login_pass_confirm" value="<?=$data['user_login_pass']?>" data-validation="required" placeholder="กรุณาระบุยืนยันรหัสผ่าน ">
						</div>
					</div>
				</div>
				<!-- /.box-body -->
				<div class="box-footer">
					...
					<a href="<?=base_url();?>" class="btn btn-default btn-flat">
