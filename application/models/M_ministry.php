...
class M_ministry extends CI_Model {
	...
	private $table				= 'ministry';
	private $code 				= 'MINISTRY_ID';
    ...
    function viewMinistryCode($code, $is_delete) {
...
/* End of file m_ministry.php */
/* Location: ./application/models/m_ministry.php */