...
class M_amphures extends CI_Model {
	
	private $table				= 'amphures';
	private $code 				= 'AMPHUR_ID';
	private $code2 				= 'AMPHUR_CODE';
	private $code3 				= 'PROVINCE_ID';
...
/* End of file m_amphures.php */
/* Location: ./application/models/m_amphures.php */