...
class M_organize extends CI_Model {
	
	private $table				= 'organize';
	private $code 				= 'ORG_ID';
	private $code2 				= 'MINISTRY_CODE';
	private $code3 				= 'DEPARTMENT_CODE';
	private $code4 				= 'ORG_CODE';
    ...
    function viewDepartmentCode($code, $is_delete) {
	...
	function viewByOrglikeName($code, $is_delete) {
		
		$this->db->where($this->is_delete, $is_delete);
		$this->db->like($this->table.'.ORG_NAME', $code);
		$query = $this->db->get($this->table);
...
/* End of file m_organize.php */
/* Location: ./application/models/m_organize.php */